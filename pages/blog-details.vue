            ...
            <div class="row row-cols-1 no-gutters">
              ...
              <div class="blog-3 blog-details col" data-aos="fade-up">
                <div class="thumbnail">
                  <img
                    class="w-100"
                    src="/images/blog/770/blog-2.jpg"
                    alt="Blog Image"
                  />
                </div>
                <div class="info">
                  ...
                  <ul class="meta mb-0 mt-4">
                    <li>
                      <i class="icofont-pen-alt-2"></i>Written by Admin, 10 Oct
                      2020
                    </li>
                    <li><i class="icofont-tags"></i>Marketing, UX Design</li>
                    <li><i class="icofont-speech-comments"></i>4 Comments</li>
                    <li class="media">
                      <a href="#"
                        ><i class="icofont-share"></i>Share this post</a
                      >
                      <div class="list">
                          ...
                          <div class="comment-content">
                            ...
                            <div class="comment-text">
                              <p>
                                ...
                                marketing. It has evolved moving from If you are
                                interested in content marketing, have a look at
                                the article's traditional media into the digital
                                landscape.
                              </p>
                            </div>
